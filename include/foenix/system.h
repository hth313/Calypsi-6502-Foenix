...
#ifndef __FOENIX_JR_SYSTEM_H__
#define __FOENIX_JR_SYSTEM_H__
...
#define SystemControl (* (volatile SystemControl_t*) 0xd6a0)
...
#define DIP_switch (* (volatile DIP_switch_t*) 0xd670)

#endif // __FOENIX_JR_SYSTEM_H__
